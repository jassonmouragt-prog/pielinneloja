      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Registre todas as saídas da loja. Impactam o lucro líquido.
          </p>
        </div>
      ...
      <Card className="bg-red-50/30 border-red-100">
        <CardContent className="pt-4 pb-4">
          ...
          <p className="text-[10px] text-muted-foreground mt-1">
            {totalCount} {totalCount === 1 ? "despesa registrada" : "despesas registradas"}
          </p>
        </CardContent>
      </Card>
                ...
                expenses.map((e: any) => {
                  ...
                  return (
                    <TableRow key={e.id}>
                      ...
                      <TableCell>
                        <div
                          className={`flex items-center gap-1.5 ${meta.color} font-medium text-sm`}
                        >
                      ...
                      <TableCell>
                        ...
                        {e.notes && (
                          <p className="text-[10px] text-muted-foreground mt-0.5">{e.notes}</p>
                        )}
                      </TableCell>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="w-[95vw] sm:max-w-md max-h-[95vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Adicione uma saída que será descontada do lucro.</DialogDescription>
          </DialogHeader>
          <Form {...form}>
