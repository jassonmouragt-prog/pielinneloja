  ...
  component: () => (
    <InstitutionalLayout title="Como Comprar">
      <ol className="space-y-6 list-decimal pl-4">
        ...
        <li>
          <strong className="text-foreground">WhatsApp:</strong> Clique em "Finalizar no WhatsApp".
          Você será enviado para o nosso atendimento com a lista de itens.
        </li>
        <li>
          <strong className="text-foreground">Conclusão:</strong> No WhatsApp, combinamos o frete e
          a forma de pagamento para enviar seu pedido!
        </li>
      </ol>
    </InstitutionalLayout>
  ),
