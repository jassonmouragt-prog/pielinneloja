    ...
    <section id="favoritos" className="bg-white">
      <div className="mx-auto max-w-[1400px] px-6 py-20 lg:px-[60px] lg:py-28">
        <Reveal className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4 sm:flex sm:items-center sm:justify-between">
          <div className="min-w-0">
            ...
            <h2 className="font-serif text-3xl font-semibold text-ink sm:text-4xl">
              Siga a <span className="italic text-silver-deep">@pielinne_semijoias</span>
            </h2>
        ...
        {isLoading ? (
          ...
          <div className="mt-10 text-center py-10 border border-dashed rounded-lg bg-gray-100">
            ...
            {posts.slice(0, 10).map((post, index) => (
              <Reveal key={post.id} delay={index * 60}>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group relative block overflow-hidden rounded-lg aspect-[4/5] glass"
                >
                  <img
                  ...
                  />
                  <div className="absolute inset-0 bg-ink/30 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
